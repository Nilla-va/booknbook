...
//     private String[] adminRoles; // ADMIN 역할을 배열로 읽음
...
//                                 .username(adminUsername) // spring.security.user.name 값 사용
//                                 .password(passwordEncoder.encode(adminPassword)) // spring.security.user.password 값 사용
//                                 .roles(adminRoles) // spring.security.user.roles 값 사용
//                                 .build();
